...
public class GZipServletFilter implements Filter {
    ...
    private boolean isIncluded(final HttpServletRequest request) {
        ...
        if (includeRequest && LOGGER.isDebugEnabled()) {
            LOGGER.debug("{} resulted in an include request. This is unusable, because the response will be assembled into the overrall response. Not gzipping.", request.getRequestURL());
        }
