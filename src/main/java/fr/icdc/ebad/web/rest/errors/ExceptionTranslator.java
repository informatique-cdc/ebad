...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleConstraintViolation(
        ...
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage("Error when when validate field");
     ...
     * Handle javax.persistence.EntityNotFoundException
     */
    @ExceptionHandler(EbadNotFoundException.class)
    protected ResponseEntity<Object> handleEbadNotFound(EbadNotFoundException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex.getMessage(), ex));
    }


    /**
     * Handle EbadServiceException
     */
